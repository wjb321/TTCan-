...
//  CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x0000;  
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh= ((((u32)0x3333<<3)|CAN_ID_EXT|CAN_RTR_REMOTE)&0xFFFF0000)>>16;		//要筛选的ID高位 
	CAN_FilterInitStructure.CAN_FilterIdLow= (((u32)0x3333<<3)|CAN_ID_EXT|CAN_RTR_REMOTE)&0xFFFF; //要筛选的ID低位 
