...
extern uint16_t CanFlag, CAN_ID;
...
void USB_LP_CAN1_RX0_IRQHandler(void) 
{
  ...
  CAN_Receive(CAN1,CAN_FIFO0, &RxMessage);  /* 此函数包含释放提出报文了的,在非必要时,不需要自己释放 */
	...
	Rx_DATA0=RxMessage.Data[0];
  Rx_DATA1=RxMessage.Data[1];
  Rx_DATA2=RxMessage.Data[2];
  Rx_DATA3=RxMessage.Data[3];
  Rx_DATA4=RxMessage.Data[4];
...
void TIM3_IRQHandler(void)   //TIM3中断
{
    ...
    CanWriteData(0x2616, 0x05, 0x04, 0x03); 
		//led_on_off();
			LED0 = !LED0;
			CanFlag = ENABLE;
			NumOfBC ++;
