...
/* Tmethod configuration */
	u16 TarrValue = 59; //9 , 19, 29, 39, 49, 59, 69, 79
	u16 TpscValue = 71;
  int Pulse = 128; 
...
//                      printf("cal is %f \r\n", (speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 );
              ...
              else
                {
                  ...
                  //Veloarray ++;
                  FillArrayTimes = 3;
                  if(speedArray[1] < ((speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 ) && speedArray[1] < speedArray[0] - 0.15 )
                    {
                      printf("speedArray[1]  is %f \r\n", speedArray[1] );
                      printf("speedArray[0] is %f \r\n", speedArray[0]);
                      printf("cal is %f \r\n", (speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 );
                  ...
                  else if(speedArray[1] >= ((speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 ) && speedArray[1] < speedArray[0] -0.15 )
                    {
                      printf("speedArray[1]  is %f\r\n", speedArray[1]);
                      printf("speedArray[0] is %f \r\n", speedArray[0]);
                      printf("cal is %f \r\n", (speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 );
                  ...
                  else if (speedArray[1] >= speedArray[0] + 0.15)
                    {
                      printf("speedArray[1]  is %f \r\n", speedArray[1] );
                      printf("speedArray[0] is %f \r\n", speedArray[0]);
                      printf("cal is %f \r\n", (speedArray[0] + sqrt(pow(speedArray[0],2) - 4* intermediate))/ 2.0 );
