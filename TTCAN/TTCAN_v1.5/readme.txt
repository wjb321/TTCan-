...
5.5.22
now the frequency can be 200hz, which means in one second it can take 200 samples to read and send by ttcan. and the model now has a simple structure.
still think the way to increase the frequency.