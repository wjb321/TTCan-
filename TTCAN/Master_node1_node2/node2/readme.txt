...
10.04.22
master: configure the TDR register to send timer stamps, understand the theory for the futher using.
slave:  configure the RDR register to receive timer stamps. 

17.4.22
master: send sm to 2 nodes, and send BC according to the given timer
node1:  receive SM, according to the SM, send relevant ID when timer values comes, and receive messages from node2
node2:  receive SM, according to the SM, send relevant ID when timer values comes, and receive messages from node1