...
void CanFilter_1_Configure()
{
  ...
  CAN_FilterInitStructure1.CAN_FilterIdHigh= ((((u32)mes1_ID<<21))&0xFFFF0000)>>16;
  CAN_FilterInitStructure1.CAN_FilterIdLow= (((u32)mes1_ID<<21)| CAN_ID_STD  |CAN_RTR_DATA)&0xFFFF; //0x123
  CAN_ITConfig(CAN1,CAN_IT_FMP1, ENABLE);   /* 挂号中断, 进入中断后读fifo的报文函数释放报文清中断标志 */
//	  CAN_FilterInitStructure1.CAN_FilterMaskIdHigh  = 0x0000;
//  CAN_FilterInitStructure1.CAN_FilterMaskIdLow   = 0x0000;
  CAN_FilterInitStructure1.CAN_FilterMaskIdHigh  = 0xFF9F;
