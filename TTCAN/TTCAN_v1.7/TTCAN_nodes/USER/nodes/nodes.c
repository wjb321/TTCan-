...
//              if((VeloVar2 > DecelerateRate * VeloVar1 &&  VeloVar1 > 0 && VeloVar2 > 0) ||(VeloThreshold <= VeloVar2  && VeloVar1 == 0 ) )
//                { 
//									printf("VeloVar1 is %d \r\n", VeloVar1);
//									printf("VeloVar2 is %d \r\n", VeloVar2);
//                  printf("it is blocked \r\n");
//                }
//              else if( (VeloVar2 < DecelerateRate * VeloVar1 &&  VeloVar1 > 0  &&  VeloVar2 > 0 )||(VeloThreshold > VeloVar2 && VeloVar2 > 0 && VeloVar1 <= 0 ) )
//                { 
//									printf("VeloVar1 is %d \r\n", VeloVar1);
//									printf("VeloVar2 is %d \r\n", VeloVar2);
//                  printf("decelerate \r\n");
...
//                  printf("celerate \r\n");
//								}
//								else if ( VeloVar2 == 0) //||  (VeloVar1 >0 && VeloVar2 == 0)
//								{
//										printf("VeloVar1 is %d \r\n", VeloVar1);
//									printf("VeloVar2 is %d \r\n", VeloVar2);
//									printf("constant speed\r\n");
